  ...
  return {
    ...
    e: common_vendor.f($data.tableData, (item, index, i0) => {
      return {
        ...
        b: "23a9fe9d-7-" + i0 + "," + ("23a9fe9d-6-" + i0),
        c: common_vendor.t(item.name),
        d: "23a9fe9d-8-" + i0 + "," + ("23a9fe9d-6-" + i0),
        e: common_vendor.t(item.address),
        f: "23a9fe9d-9-" + i0 + "," + ("23a9fe9d-6-" + i0),
        g: "23a9fe9d-10-" + i0 + "," + ("23a9fe9d-6-" + i0),
        h: index,
        i: "23a9fe9d-6-" + i0 + ",23a9fe9d-0"
      };
    }),
    f: common_vendor.p({
      align: "center"
    }),
    g: common_vendor.sr("table", "23a9fe9d-0"),
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/surloki/Documents/git-repos/uni-app-projects/demo01/hello-uni-app/pages/extUI/table/table.vue"]]);
