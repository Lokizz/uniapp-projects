...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.f(4, (item, index, i0) => {
      return {
        a: "18968d3f-4-" + i0 + "," + ("18968d3f-3-" + i0),
        b: index,
        c: "18968d3f-3-" + i0 + ",18968d3f-2",
        d: common_vendor.p({
          index
        })
      };
    ...
    g: common_vendor.f(8, (item, index, i0) => {
      return {
        a: "18968d3f-8-" + i0 + "," + ("18968d3f-7-" + i0),
        b: index,
        c: "18968d3f-7-" + i0 + ",18968d3f-6",
        d: common_vendor.p({
          index
        })
      };
    ...
    D: common_vendor.f($data.list, (item, index, i0) => {
      return common_vendor.e({
        ...
        d: "18968d3f-22-" + i0 + "," + ("18968d3f-21-" + i0),
        e: common_vendor.p({
          text: item.badge,
          type: item.type
        })
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/surloki/Documents/git-repos/uni-app-projects/demo01/hello-uni-app/pages/extUI/grid/grid.nvue"]]);
