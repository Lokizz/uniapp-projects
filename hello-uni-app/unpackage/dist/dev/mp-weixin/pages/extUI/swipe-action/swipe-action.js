  ...
  return {
    ...
    x: common_vendor.f($data.swipeList, (item, index, i0) => {
      return {
        ...
        e: "96de84c2-14-" + i0 + ",96de84c2-13",
        f: common_vendor.p({
          ["right-options"]: item.options
        })
      };
    }),
    y: common_vendor.sr("swipeAction", "96de84c2-13")
  };
}
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/surloki/Documents/git-repos/uni-app-projects/demo01/hello-uni-app/pages/extUI/swipe-action/swipe-action.vue"]]);
