...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    g: common_vendor.f($data.listData, (item, k0, i0) => {
      return {
        a: "2434cb0e-10-" + i0 + "," + ("2434cb0e-9-" + i0),
        b: item.id,
        c: "2434cb0e-9-" + i0 + ",2434cb0e-8",
        d: common_vendor.p({
          title: item.author_name,
          avatar: item.cover,
          note: item.title,
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/surloki/Documents/git-repos/uni-app-projects/demo01/hello-uni-app/pages/extUI/list/chat.vue"]]);
